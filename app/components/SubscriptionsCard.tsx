...
const SubscriptionsCard = ({ name, price, currency, icon, billing, color, category, plan, renewalDate,status, expanded, onPress ,paymentMethod ,startDate }: SubscriptionCardProps) => {
